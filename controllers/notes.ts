...
export const createNote: RequestHandler<any, any, any, any> = async (
  req,
  res,
  next
) => {
...
export const findOne: RequestHandler<any, any, any, any> = async (
  req,
  res,
  next
) => {
...
export const updateNote: RequestHandler<any, any, any, any> = async (
  req,
  res,
  next
) => {
