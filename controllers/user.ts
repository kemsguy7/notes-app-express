...
export const login: RequestHandler =  async (req, res) => {
 ...
 export const findSingle: RequestHandler<any, any, any, any>  = async (req, res, next) => { 
    try {
 ...
 export const updateUser: RequestHandler<any, any, any, any>  = async (req, res, next) => { 
    try {
 ...
 export const deleteUser: RequestHandler<any, any, any, any>  = async (req, res, next) => { 
    try {
